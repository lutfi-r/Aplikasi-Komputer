...
\end{eulerprompt}
\begin{eulercomment}
Sekarang tentukan tiga titik dan gambarkan.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Fungsi-fungsi geometri mencakup fungsi untuk membuat garis dan
...
\end{euleroutput}
\begin{eulercomment}
Sekarang lingkaran juring dari segitiga.
\end{eulercomment}
\begin{eulerprompt}
...
File geometry.e menyediakan fungsi yang sama (dan lebih banyak) di
...
menyediakan perhitungan simbolik.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Pertemuan sebuah garis dengan lingkaran menghasilkan dua titik dan
jumlah titik perpotongan.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  ...
  Error in:
  ... olve([diff(H(a,b,c)^2,a)=la,diff(H(a,b,c)^2,b)=la ...
                                                       ^
\end{euleroutput}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Kita bisa membuat plot situasinya. Pertama-tama atur poin di Maxima.
\end{eulercomment}
\begin{eulerprompt}
>A &= at([x,y],sol[2]); $A
\end{eulerprompt}
...
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
>plot3d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\end{eulernotebook}
\end{document}
